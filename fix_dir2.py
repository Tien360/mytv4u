...
pattern = r"(children: _actors\.take\(6\)\.map.*?\)\.toList\(\),\s*\),\s*)"
if re.search(pattern, content, flags=re.DOTALL):
    content = re.sub(pattern, lambda m: m.group(1) + directors_ui, content, count=1, flags=re.DOTALL)
else:
    print("Pattern not found!")

with open("lib/screens/movie_detail_screen.dart", "w", encoding="utf-8") as f:
    f.write(content)
print("Added directors properly")
