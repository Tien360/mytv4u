...
start_idx = text.find("  Widget _buildMatchCard(SportMatch match) {")
end_idx = text.find("class SportLivescoreWidget extends StatefulWidget {")

if start_idx != -1 and end_idx != -1:
    # Need to find the end of the class `SportScreenState` before `SportLivescoreWidget`
    # The end of `_buildMatchCard` should be before `}\n\nclass SportLivescoreWidget`
    
    # Actually, just replace from start_idx to end_idx - 3
