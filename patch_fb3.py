...
version = "26.08.22.l.beta"
notes = "🚀 Cập nhật Phiên bản 26.08.22.l.beta\n\n🎉 Tính năng mới:\n- Sửa lỗi nhận diện nhầm VOD thành Livestream do URL chứa các từ khóa như 'stream'.\n- Tinh chỉnh thuật toán ẩn thông báo kết thúc tập phim để chỉ áp dụng cho Livestream thực sự."
channel = "beta"
