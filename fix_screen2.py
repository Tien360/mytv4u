                                                    ...
                                                    try {
                                                      ...
                                                      if (diff > 0) {
                                                        if (isFinale) {
                                                          ...
                                                          phrases = L10n.tList('ep_msg_future_normal');
                                                        }
                                                      } else if (diff == 0) {
                                                        if (!isAvailable) {
                                                      ...
                                                      if (diff == 0 && isAvailable && !isFinale) {
                                                         ...
                                                         List<String> nextArr = [
                                                           L10n.t('ep_msg_next_estimated', {'DATE': estStr}),
                                                     ...
                                                     List<String> phrases = [];
                                                     if (_movie!.type.toLowerCase() == 'single' || _movie!.type.toLowerCase() == 'movie' || totalEps <= 1) {
                                                        phrases = L10n.tList('ep_msg_completed_movie');
                                                     } else if (totalEps <= 10) {
...
text = re.sub(r'if \(_tmdbDetails!\[\'next_episode_to_air\'\] != null.*?\]\,?\s*(?=if \(_tmdbDetails!\[\'budget\'\] != null)', lambda m: replacement, text, flags=re.DOTALL)
