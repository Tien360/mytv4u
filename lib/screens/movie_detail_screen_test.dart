...
class MovieDetailScreenTest extends StatefulWidget {
  final String slug;
  final String? heroTag;
  final Movie? initialMovie;

  const MovieDetailScreenTest({
    super.key,
    required this.slug,
    this.heroTag,
    this.initialMovie,
  ...
  @override
  State<MovieDetailScreenTest> createState() => _MovieDetailScreenTestState();
}
      ...
      if (results.isNotEmpty) {
        ...
        if (mounted) {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => MovieDetailScreenTest(slug: bestMatch.slug, initialMovie: bestMatch),
            ),
          );
        }
      } else {
