...
void main() async {
  String version = '26.08.16.c.public';
  String notes = 'Cập nhật thuật toán tối ưu nguồn phim Premium ở trang chủ, tính năng đa ngôn ngữ, tự động tải ảnh ngang chất lượng cao, thêm công cụ tìm kiếm trong Tivi.';
