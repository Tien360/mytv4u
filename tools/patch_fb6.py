...
version = '26.08.19.m.beta'
channel = 'beta'
notes = '- Cập nhật: Sửa lỗi hiển thị sai tên mục Chất lượng video thành tab_video và lỗi chỉ hiển thị chữ x thay vì độ phân giải trong cài đặt Trình phát.'
