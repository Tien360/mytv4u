...
version = '26.08.19.f.beta'
channel = 'beta'
notes = '- Thêm tùy chọn ép chất lượng Video (1080p, 720p...) trong phần Cài đặt Chung của trình phát.\n- Tích hợp Film4K.net làm nguồn phim gốc chất lượng cao (demuxed M3U8).'
