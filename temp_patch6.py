...
# 3. YOUTUBE CARD LAYOUT FIX
if "// YouTube" in content:
    # It was placed inside _buildUserCard's row, and _buildLoginCard's column (which is fine for LoginCard).
    # But for UserCard, we need to fix it!
    # Let's find it in UserCard:
    ...
    # Row( ... )
    # ], ), ); }
    # We should change the top level of child to a Column!
    # Wait, instead of complicated regex for layout, I'll just rewrite _buildUserCard manually using string replace!
