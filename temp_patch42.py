...
search_str = "SwitchListTile(\n                                          title: Text(L10n.t('hw_accel')),\n"

idx = content.find(search_str)
if idx != -1:
    content = content[:idx] + video_block + content[idx:]
    print("Injected skip_intro and background_playback before hw_accel!")
    with open('lib/screens/settings_screen.dart', 'w', encoding='utf-8') as f:
        f.write(content)
else:
    print("Could not find hw_accel block!")
